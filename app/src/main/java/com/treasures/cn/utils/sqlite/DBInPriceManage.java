 ...
 * @Version: 1.0
 */
public class DBInPriceManage implements ResultSetHandler<Double>  {
    @Override
    public Double handle(Cursor cursor) throws BusiException {
        return cursor.getDouble(cursor.getColumnIndexOrThrow(DataBaseFactory.FIELD_BUY_PRICE));
    }
     ...
     */
    public static double getAllInPrice() throws BusiException {
