...
public class UtilUI {
    ...
    public Bitmap getDrawing(View view) {
        try {
            ...
            //需要截取的长和宽
            int dp_50 = ClientApp.mInstance.getResources().getDimensionPixelSize(R.dimen.dp_50);
            int dp_20 = ClientApp.mInstance.getResources().getDimensionPixelSize(R.dimen.dp_20);
            int dp_180 = ClientApp.mInstance.getResources().getDimensionPixelSize(R.dimen.dp_180);
            int outWidth = ScreenUtils.getWidth(ClientApp.mInstance) - dp_50;
            int outHeight = dp_180;
            int outX = dp_50/2;
            int outY = (ScreenUtils.getHeight(ClientApp.mInstance)-outHeight-dp_20)/2;
            tBitmap = tBitmap.createBitmap(tBitmap,outX,outY,outWidth,outHeight);
